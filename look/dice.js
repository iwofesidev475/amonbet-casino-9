...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-58d605f1');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-58d605f1');}
...
var brandEl=document.querySelector('.rl-brand-58d605f1');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
